          ...
          >
            ...
            <div>
              <EmailInput
                ...
                className={`${errors.email ? "border-red-400 focus:border-red-500 focus:ring-red-500/20" : th.input} h-10 w-full rounded-full border bg-transparent px-5 py-2.5 text-sm transition-colors duration-200 outline-none focus:ring-2 disabled:opacity-50`}
              />
              {errors.email && (
                <p
                  id="email-error"
