...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const showVimeo = () => {
        gsap.to(vimeoContainer, { opacity: 1, duration: 0.7, ease: "power2.out" });
      ...
      const hideVimeo = () => {
        gsap.to(vimeoContainer, { opacity: 0, duration: 0.7, ease: "power2.in" });
  ...
  return (
    <section ref={wrapperRef} data-header-theme="light" className="h-[300vh]">
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="font-display text-3xl tracking-wide text-white xs:text-6xl lg:text-7xl">
            Where longevity
            <br />
            is lived.
          </h1>
          <p className="mt-4 text-base text-white/80 md:text-lg">
            Longevity and social welfare center in Tenerife
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Button href="/booking" variant="white" size="lg">
              Booking
            </Button>
            <Button href="/community/memberships" variant="outline-white" size="lg">
              Become a member
            </Button>
          </div>
        </div>
