          ...
          <div ref={bodyRef} className="flex flex-col gap-12 md:gap-16">
            ...
            <div className="md:max-w-lg">
              ...
              <p className="text-petroleum-400 mt-4 leading-relaxed">
                Essentia Medicine is not reactive healthcare. It is a
                precision-driven system built to detect, prevent, and reverse
                the biological processes that accelerate ageing.
              </p>
            </div>
