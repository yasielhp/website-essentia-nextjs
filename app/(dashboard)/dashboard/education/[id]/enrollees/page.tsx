...
export default function EnrolleesPage() {
  ...
  async function openAdd() {
    ...
    const registeredContactIds = enrollees
      .map((e) => e.contact_id)
      .filter(Boolean) as string[];
                ...
                enrollees.map((enrollee, index) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      {confirmRemoveId === enrollee.id ? (
                        <div className="flex items-center gap-1.5">
                          <span className="text-petroleum-400 text-xs">
                            Remove?
                          </span>
                          <button
                            onClick={() => void handleRemove(enrollee.id)}
                        ...
                        <button
                          onClick={() => setConfirmRemoveId(enrollee.id)}
