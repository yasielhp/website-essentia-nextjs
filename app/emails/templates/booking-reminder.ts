        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #d7dbd9;">
          ...
          <tr>
            <td style="padding:32px;">
              <p style="margin:0 0 8px;font-size:14px;color:#4a6767;text-transform:uppercase;letter-spacing:1px;">Reminder</p>
              <h1 style="margin:0 0 24px;font-size:24px;font-weight:600;color:#103838;line-height:1.3;">
                Your session is tomorrow, ${name}
              </h1>
              <p style="margin:0 0 24px;font-size:16px;color:#335554;line-height:1.6;">
                This is a friendly reminder that your session at Essentia is scheduled for tomorrow. We look forward to seeing you.
              </p>
                ...
                <tr>
                  <td style="padding:20px 24px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:6px 0;font-size:14px;color:#4a6767;">Time</td>
                        <td style="padding:6px 0;font-size:14px;font-weight:500;color:#103838;">${time}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <p style="margin:0;font-size:14px;color:#4a6767;line-height:1.6;">
                Need to cancel or reschedule? Please contact us as soon as possible so we can adjust your booking.
              </p>
            </td>
          </tr>
